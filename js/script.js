...
const GRAVITY = 1.3; // Acceleration in px/s
let simSpeed = 1.3;
...
const soundManager = {
  ...
  playSound(type, scale = 1) {
    ...
    const scaledVolume = initialVolume * scale * 0.3; // Giảm tiếng pháo hoa còn 30%
    ...
    // Add low-pass filter for warm, rounded sound
    const filterNode = this.ctx.createBiquadFilter();
    filterNode.type = 'lowpass';
    filterNode.frequency.value = 3000; // Làm âm thanh ấm hơn bằng cách giới hạn tần số cao
